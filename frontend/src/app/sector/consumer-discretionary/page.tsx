...
export default function ConsumerDiscretionaryPage() {
    return (
        <div className="min-h-screen flex flex-col items-center p-6">
            <Link href="/" className="text-4xl font-extrabold mb-4 text-blue-600 hover:underline">
                ← Back to Home
            </Link>
            <h1 className="text-5xl font-bold mb-6">Consumer Discretionary</h1>
            ...
            <div className="mt-6">
                ...
                <Image
                    src="/sector-images/consumer-discretionary.png"
                    alt="Consumer Discretionary Heatmap"
                    width={800}
                    height={500}
